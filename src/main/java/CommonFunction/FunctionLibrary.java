...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser(WebDriver driver) throws Throwable {
		...
		if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdriver.gecko.driver", "D:\\Stock_Accounting\\CommonJars\\geckodriver.exe");
			...
			System.setProperty("webdriver.gecko.driver", "D:\\Stock_Accounting\\CommonJars\\IEdriver.exe");
		}
